...
export function Notificacoes() {
  return (
    <SonnerToaster
      position="top-center"
      offset={28}
      // No celular o toast descia 28px e pousava exatamente sobre a marca e
      // os botões do cabeçalho — 4,5 segundos tapando a única navegação da
      // tela. Colado no alto ele continua sendo a primeira coisa que se lê,
      // sem cobrir o que estava ali.
      ...
      style={{ width: 'min(30rem, calc(100vw - 1rem))' }}
      toastOptions={{
        unstyled: true,
        classNames: {
          toast:
            'flex w-full items-center gap-3 rounded-2xl px-4 py-4 shadow-2xl shadow-black/50 ring-1 ring-black/15 sm:gap-4 sm:px-6 sm:py-5',
