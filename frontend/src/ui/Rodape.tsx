    ...
    <footer className={`space-y-4 ${className}`.trim()}>
      ...
      <p className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center text-xs text-tinta-tenue">
        ...
        <a
          ...
          className="inline-flex min-h-11 items-center font-display text-base font-semibold text-marca underline decoration-marca/40 underline-offset-4 transition-colors hover:decoration-marca hover:brightness-110"
        >
          Cielio Queiroz
        </a>
      </p>
