...
export const pt = {
  ...
  'grafico.categoriasDescricao': 'Distribuição das saídas no recorte',
  'grafico.diarioDescricao': 'Picos de gasto pela data real',
  'grafico.evolucaoDescricao': 'Comparação por competência',
  'comparativo.titulo': 'Receitas × despesas',
  'comparativo.descricao': 'Quanto entrou, quanto saiu e o que sobrou no recorte',
  'comparativo.entradas': 'Receitas',
  'comparativo.gastos': 'Despesas',
  'comparativo.consumo': '{pct}% da renda consumida',
  'comparativo.semEntrada': 'sem receita no recorte',
  'comparativo.consumoTitulo': 'Consumo da renda',
  'comparativo.gastoLegenda': 'Gasto',
  'comparativo.guardadoLegenda': 'Disponível',
  'comparativo.resultado': 'Resultado',
  'comparativo.taxaEconomia': 'Taxa de economia',
  'leituras.titulo': 'Leituras do período',
  'leituras.descricao': 'Sinais calculados a partir dos seus documentos',
  'leituras.maiorCategoria': 'Maior categoria',
  'leituras.maiorCategoriaTexto': '{categoria} concentrou {pct}% do gasto ({valor}).',
  'leituras.maiorEstabelecimento': 'Maior estabelecimento',
  'leituras.maiorEstabelecimentoTexto': '{estabelecimento} somou {valor} em {n} compras.',
  'leituras.picoGasto': 'Pico de gasto',
  'leituras.picoGastoTexto': 'O maior dia foi {data}, com {valor} em saídas.',
  'leituras.economia': 'Taxa de economia',
  'leituras.economiaTexto': 'Sobrou {valor}, equivalente a {pct}% das entradas.',
  'leituras.verLancamentos': 'Ver lançamentos',
  'leituras.verDia': 'Ver este dia',
  'dash.menu': 'Menu',
  ...
  'fluxo.titulo': 'Fluxo financeiro',
  'fluxo.descricao': 'Entradas, saídas e resultado por competência',
  'fluxo.modoRotulo': 'Leitura',
  'fluxo.modoAcumulado': 'Saldo acumulado',
  'fluxo.modoPeriodo': 'Resultado do período',
  'fluxo.rotulo': 'Fluxo financeiro com leitura de {modo}',
  'fluxo.rotuloPonto': '{mes}: entradas {entradas}, saídas {saidas}, resultado {resultado}. Ver este mês.',
  'fluxo.rodapeAcumulado': 'A linha tracejada mostra o saldo acumulado',
  'fluxo.rodapePeriodo': 'A linha tracejada mostra o resultado de cada período',
  ...
  'lista.semLancamentos': 'Sem lançamentos neste período.',
  'lista.semDespesas': 'Sem despesas neste período.',
  'lista.data': 'Data',
  'lista.descricao': 'Descrição',
  ...
  'rota.situacao': 'Minha situação financeira',
  'rota.relatorios': 'Relatórios',
  'comandos.abrir': 'Abrir navegação rápida',
  'comandos.atalho': 'Buscar',
  'comandos.titulo': 'Navegação rápida',
  'comandos.placeholder': 'Ir para uma seção…',
  'comandos.atual': 'aberta',
  'comandos.vazio': 'Nenhuma seção encontrada.',
  'header.voltarSecao': 'Voltar',
  'situacao.eyebrow': 'Sua trajetória',
  'situacao.titulo': 'Minha situação financeira',
  'situacao.evolucaoTitulo': 'Evolução do histórico',
  'situacao.descricao': 'Uma leitura da evolução do seu dinheiro a partir do histórico importado.',
  'situacao.janela3': '3 meses',
  'situacao.janela6': '6 meses',
  'situacao.janela12': '12 meses',
  'situacao.semDados': 'Importe mais documentos para construir sua trajetória financeira.',
  'situacao.saldoAtual': 'Saldo atual',
  'situacao.saldoAtualDesc': 'Saldo mais recente encontrado em {n} contas de extrato.',
  'situacao.saldoIndisponivel': 'Ainda não há saldo declarado por um extrato importado.',
  'situacao.momentosTitulo': 'Momentos da sua trajetória',
  'situacao.momentosDescricao': 'O melhor e o mais caro entre os {n} meses selecionados.',
  'situacao.documentosAviso': 'Tudo vem dos documentos importados',
  'situacao.melhorMes': 'Melhor mês',
  'situacao.melhorMesTexto': 'Resultado positivo de {valor}.',
  'situacao.receitas': 'Receitas',
  'situacao.despesas': 'Despesas',
  'situacao.economia': 'Economia',
  'situacao.taxaEconomia': 'Taxa de economia',
  'situacao.mesMaisCaro': 'Mês mais caro',
  'situacao.mesMaisCaroTexto': 'Gasto total de {valor}.',
  'situacao.mesMaisCaroCategorias': 'Principais categorias desse mês',
  'situacao.compararPeriodos': 'Comparar períodos',
  'situacao.esconderComparacao': 'Esconder comparação',
  'situacao.comparacaoTitulo': 'Comparação da trajetória',
  'situacao.comparacaoDescricao': 'A janela atual contra os {n} meses anteriores.',
  'situacao.comparacaoDisponivel': 'Comparação disponível',
  'situacao.comparacaoIndisponivel': 'Histórico insuficiente',
  'situacao.comparacaoAjuda': 'Importe mais meses para comparar sua trajetória com segurança.',
  'situacao.linhaTempoTitulo': 'Linha do tempo financeira',
  'situacao.linhaTempoDescricao': 'Selecione um mês para destacar sua leitura no gráfico.',
  'situacao.selecionarMes': 'Selecionar {mes}',
  'relatorios.eyebrow': 'Leitura aprofundada',
  'relatorios.titulo': 'Relatórios financeiros',
  'relatorios.descricao': 'Uma visão mais detalhada do seu histórico importado.',
  'relatorios.janela3': '3 meses',
  'relatorios.janela6': '6 meses',
  'relatorios.janela12': '12 meses',
  'relatorios.semDados': 'Importe documentos para gerar um relatório do seu histórico.',
  'relatorios.resumoAria': 'Resumo financeiro do período',
  'relatorios.receitas': 'Receitas',
  'relatorios.despesas': 'Despesas',
  'relatorios.resultado': 'Resultado',
  'relatorios.resultadoDescricao': 'O que sobrou depois das saídas.',
  'relatorios.taxaEconomia': 'Taxa de economia',
  'relatorios.periodoResumo': 'Consolidado de {n} meses',
  'relatorios.variacao': '{valor} contra o período anterior',
  'relatorios.semComparacao': 'Sem período anterior para comparar',
  'relatorios.comparadoAnterior': 'Período anterior: {valor}',
  'relatorios.fluxoTitulo': 'Evolução de receitas e despesas',
  'relatorios.fluxoDescricao': 'Como o resultado mudou ao longo do período.',
  'relatorios.categoriasTitulo': 'Mudança por categoria',
  'relatorios.categoriasDescricao': 'Distribuição das saídas no recorte escolhido.',
  'relatorios.insightsTitulo': 'Onde mais saiu dinheiro',
  'relatorios.insightsDescricao': 'Estabelecimentos que mais concentraram suas saídas.',
  'relatorios.semInsights': 'Ainda não há saídas suficientes para esta leitura.',
  'relatorios.maioresSaidasTitulo': 'Maiores saídas',
  'relatorios.maioresSaidasDescricao': 'As compras de maior valor no recorte.',
  'relatorios.semSaidas': 'Nenhuma saída encontrada no período.',
  'relatorios.provenienciaTitulo': 'Como este relatório é calculado',
  'relatorios.provenienciaDescricao': 'Os números são recalculados a partir das transações dos documentos importados e respeitam o mesmo recorte do Painel.',
  'relatorios.provenienciaAviso': 'Não há metas, orçamentos ou valores digitados manualmente nesta leitura.',
